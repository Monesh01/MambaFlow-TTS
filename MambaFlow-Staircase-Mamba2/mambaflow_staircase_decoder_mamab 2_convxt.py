...
class MambaFlowStaircasePyramidDecoder(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.l1_mamba = BiMamba2ConformerBlock(
            d_model=d_mid,
            d_t=d_t,
            d_state=64,
            d_conv=4,
            expand=2,
            headdim=64,
            kernel_size=kernel_size_coarse,
            dropout=dropout,
        )
        ...
        self.l2_mamba = BiMamba2ConformerBlock(
            d_model=d_mid,
            d_t=d_t,
            d_state=64,
            d_conv=4,
    ...
    def predict_velocity(self, x, t, mu, mask=None):
        ...
        h_l1 = self._run_block(self.l1_mamba, h_l1_in, t_emb, mask_l1)
        ...
        h_l2 = self._run_block(self.l2_mamba, h_l2_fused, t_emb, mask_l2)
        ...
        # LEVEL 3: Full-Resolution Scale (T) with Early Staircase Fusion
        # =====================================================================
        # Early Staircase Fusion: inject Level 2 mid-scale features before Level 3 ConvNeXt
        h_l3_fused = h_t + p2
        h_l3_fused = self._run_block(self.l3_smooth, h_l3_fused, t_emb, mask_pad)

        # Pure ConvNeXt harmonic & formant refinement (eliminates SSM low-pass temporal smearing)
        h_l3 = self._run_block(self.l3_conv1, h_l3_fused, t_emb, mask_pad)
